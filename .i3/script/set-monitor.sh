...
if type "xrandr"; then
    ...
    if [ $count == 2 ]; then
        ...
        if [ $ret == 1 ]; then
            ...
            /bin/bash ~/.i3/script/monitor-vga.sh &
        fi
    else
...
$(sleep 1;feh --no-fehbg --bg-scale ~/Imagens/Wall/aenami/alena-aenami-004-1k1.jpg ~/Imagens/Wall/aenami/alena-aenami-lines1k.jpg &)